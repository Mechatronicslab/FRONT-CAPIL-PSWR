  ...
  <q-page>
    <div class="q-pa-md">
              ...
              <q-tab-panel name="keluarga" class="col">
                <div v-for="(d, i) in keluarga" :key="i">
                  <div class="row">
                    ...
                    <q-item class="col">
                      <q-item-section>
                        <q-item-label caption>Nama</q-item-label>
      ...
      <div class="row items-start q-gutter-md q-mt-sm">
        ...
        <!-- <q-card class="my-card">
          <q-card-section>
            <div class="text-subtitle2 text-indigo-10">Penerima Bantuan</div>
        ...
        <!-- <div class="col">
          <q-card class="my-card">
            <q-card-section>
              <div class="text-subtitle2 text-indigo-10">Penghasilan</div>
              <div class="text-caption text-grey">Data penghasilan penduduk</div>
              <Bar :data="chartData" />
            </q-card-section>
          </q-card>
          <q-card class="my-card q-mt-sm">
            <q-card-section>
              <div class="text-subtitle2 text-indigo-10">Status Pernikahan</div>
              <div class="text-caption text-grey">Data status pernikahan</div>
              <Line :data="dataLine" />
            </q-card-section>
          </q-card>
        </div> -->
        <!-- <q-card class="my-card">
          <q-card-section>
            <div class="text-subtitle2 text-indigo-10">Pemilik Akte</div>
            <div class="text-caption text-grey">Data penduduk pemilik akte</div>
            <Bar :data="chartData" />
          </q-card-section>
        </q-card>
        <q-card class="my-card">
          <q-card-section>
            <div class="text-subtitle2 text-indigo-10">Pemilik E-KTP</div>
            <div class="text-caption text-grey">
              Data penduduk pemilik E-KTP
            </div>
            <Line :data="dataLine" />
          </q-card-section>
        </q-card>
        <q-card class="my-card">
          <q-card-section>
            <div class="text-subtitle2 text-indigo-10">Sumber Air Minum</div>
            <div class="text-caption text-grey">
              Data sumber air minum penduduk
            </div>
            <Line :data="dataLine" />
          </q-card-section>
        </q-card>
        <q-card class="my-card">
          <q-card-section>
            <div class="text-subtitle2 text-indigo-10">Sumber Penerangan</div>
            <div class="text-caption text-grey">
              Data sumber penerangan penduduk
            </div>
            <Bar :data="chartData" />
          </q-card-section>
        </q-card>
        <q-card class="my-card">
          <q-card-section>
            <div class="text-subtitle2 text-indigo-10">Pengguna Handphone</div>
            <div class="text-caption text-grey">
              Data penduduk pengguna handphone
            </div>
            <Bar :data="chartData" />
          </q-card-section>
        </q-card>
        <q-card class="my-card">
          <q-card-section>
            <div class="text-subtitle2 text-indigo-10">Bahan Bakar Masak</div>
            <div class="text-caption text-grey">
              Data penggunaan bahan bakar masak
            </div>
            <Bar :data="chartData" />
          </q-card-section>
        </q-card>
        <q-card class="my-card">
          <q-card-section>
            <div class="text-subtitle2 text-indigo-10">Fasilitas BAB</div>
            <div class="text-caption text-grey">Data fasilitas BAB</div>
            <Bar :data="chartData" />
          </q-card-section>
        </q-card> -->
      </div>
